...
fun NavGraphBuilder.featureConsentUserGraph(navController: NavController) {
    navigation(
        startDestination = ConsentUserScreens.Welcome.screenRoute,
        route = ModuleRoute.ConsentUserModule.route
    ) {

        composable(route = ConsentUserScreens.Welcome.screenRoute) {
