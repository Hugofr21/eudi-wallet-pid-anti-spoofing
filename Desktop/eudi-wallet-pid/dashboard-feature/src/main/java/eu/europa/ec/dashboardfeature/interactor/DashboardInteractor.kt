        ...
        return buildList {
            ...
            add(
                SideMenuItemUi(
                    ...
                    data = ListItemDataUi(
                        ...
                        mainContentData = ListItemMainContentDataUi.Text(
                            text = resourceProvider.getString(R.string.settings_screen_option_backup)
                        ),
                        leadingContentData = ListItemLeadingContentDataUi.Icon(
            ...
            add(
                SideMenuItemUi(
                    ...
                    data = ListItemDataUi(
                        itemId = resourceProvider.getString(R.string.settings_screen_option_profile_id),
                        mainContentData = ListItemMainContentDataUi.Text(
                            text = resourceProvider.getString(R.string.settings_screen_profile_backup)
                        ),
                        leadingContentData = ListItemLeadingContentDataUi.Icon(
